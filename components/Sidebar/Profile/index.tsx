    ...
    >
      <div className={styles.head} onClick={() => setVisible(!visible)}>
        <Avatar
          ...
          photo={userDetails?.profile_pic ?? "/images/avatar.png"}
          online={true}
        />
        <div className={styles.details}>
          <div className={styles.name}>{userDetails?.first_name}</div>
          <div className={styles.login}>@{userDetails?.username}</div>
        </div>
